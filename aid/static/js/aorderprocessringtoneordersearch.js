/*
aorderprocessringtoneordersearch.js
*/
...
$('a[href="/aid/aorderprocessringtoneordersearch/"]').parent().addClass('active');
    ...
    $('#searchbutton').click(function() {
            ...
            $.ajax({
                type: 'POST',
                url: 'aorderprocessringtoneordersearchcontent/',
    ...
    $('body').on("click", ".sendtomebutton", function() {
        var ringtonemasterfileid = $(this).attr('ringtonemasterfileid');
        console.log(ringtonemasterfileid);
