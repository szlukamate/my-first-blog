...
INSERT INTO `quotation_tblcompanies` VALUES (1,'Apple Inc.'),(2,'Company2'),(6,'Company3'),(7,'DefaultCompany');
...
INSERT INTO `quotation_tbldoc` VALUES (1,'6726','Szeged',1,4,'Apple Inc.','Steve','Jobs','2018-12-12 16:47:30','				gf\nfg\ndf\ndf\n\nffffffffffffffffffddddddddddddd							  ',0),(2,'7777','Pécs',1,3,'Company2','firstname2','lastname2','2018-12-12 16:47:30','',0),(3,'9999','Győr',1,4,'Company1','Firstname1','Lastname1','2018-12-12 16:47:30','',0),(4,'5555','Békéscsaba',2,1,NULL,NULL,NULL,'2018-12-12 16:47:30','',0),(5,'4444','Nyíregyháza',3,1,NULL,NULL,NULL,'2018-12-12 16:47:30','',1),(6,'3333','Eger',3,1,NULL,NULL,NULL,'2018-12-12 16:47:30','',1),(9,NULL,NULL,1,2,NULL,NULL,NULL,'2018-12-12 16:47:30','',1),(10,NULL,NULL,1,4,NULL,NULL,NULL,'2019-01-29 12:34:46',NULL,1),(11,NULL,NULL,1,4,NULL,NULL,NULL,'2019-01-29 12:36:44',NULL,1),(12,NULL,NULL,1,4,NULL,NULL,NULL,'2019-01-29 12:37:37',NULL,0),(13,NULL,NULL,1,4,NULL,NULL,NULL,'2019-01-29 13:20:57',NULL,1),(14,NULL,NULL,1,4,NULL,NULL,NULL,'2019-01-29 13:23:12',NULL,1),(15,NULL,NULL,1,4,NULL,NULL,NULL,'2019-01-29 13:25:31',NULL,1),(16,NULL,NULL,1,4,'Apple Inc.','Steve','Jobs','2019-01-29 13:42:01',NULL,0);
...
--
-- Table structure for table `quotation_tblpreface`
--

DROP TABLE IF EXISTS `quotation_tblpreface`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `quotation_tblpreface` (
  `prefaceid_tblpreface` int(11) NOT NULL AUTO_INCREMENT,
  `prefacetext_tblpreface` text NOT NULL,
  PRIMARY KEY (`prefaceid_tblpreface`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `quotation_tblpreface`
--

LOCK TABLES `quotation_tblpreface` WRITE;
/*!40000 ALTER TABLE `quotation_tblpreface` DISABLE KEYS */;
INSERT INTO `quotation_tblpreface` VALUES (2,'Thank you for your inquery.');
/*!40000 ALTER TABLE `quotation_tblpreface` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-01-29 22:08:11
