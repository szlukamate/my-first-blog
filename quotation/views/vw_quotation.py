...
# applicable ipaddress  end
    ...
    subprocess.call('google-chrome --headless --site-per-process --print-to-pdf=' + BASE_DIR + '/emailattachmentspre/' + str(creatorid) + '/' + pdffilename + ' http://' + appliableipaddress + ':8000/quotation/quotationprint/' + docid + '/', shell=True)
