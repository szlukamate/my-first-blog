...
urlpatterns = [
    ...
    url(r'^quotationnewrow/(?P<pkdocid>[0-9]+)/(?P<pkproductid>[0-9]+)/$', views.quotationnewrow, name='quotationnewrow'),
    url(r'^quotationnewrowadd/(?P<pk>[0-9]+)/$', views.quotationnewrowadd, name='quotationnewrowadd'),
