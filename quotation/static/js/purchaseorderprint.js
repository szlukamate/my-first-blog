...
main();
    ...
    function backpagehandling(){
            ...
            var purchaseorderid = $('#purchaseorderid').text();
            $.ajax({
                type: 'POST',
                url: 'purchaseorderbackpage/',
    ...
    function pagenumberer(){
            ...
            $('span[class="firstpagefooterspan3"]').text( "Number of Purchase Order: " + $('#numberofpurchaseorder').text()); // firstpage footer filling
            ...
            $('span[class="middlepagesfooterspan3"]').text( "Number of Purchase Order: " + $('#numberofpurchaseorder').text()); // middlepages number of purchaseorder filling

            $('span[class="backpagefooterspan2"]').text( "page " + (pagenumber+1) + "/" + (pagenumber+1)); // backpage footer filling
            $('span[class="backpagefooterspan3"]').text( "Number of Purchase Order: " + $('#numberofpurchaseorder').text()); // backpage footer filling
