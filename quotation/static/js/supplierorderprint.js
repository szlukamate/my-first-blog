...
main();
    ...
    function backpagehandling(){
            ...
            var supplierorderid = $('#supplierorderid').text();
            $.ajax({
                type: 'POST',
                url: 'supplierorderbackpage/',
    ...
    $('span[name="htmlinsertbefore"][rowid="' + rowid + '"').html('<div class="header" ><div class="headerlabels" ><span style="margin-left: 35mm" >Description</span><span style="margin-left: 44mm" >Qty</span><span class="headerlabelunitprice" >Unit Price</span><span class="headerlabelscurrencycodespanforunitprice">in ' + currencycode + '</span><span class="headerlabelsalesprice" >Purchase Price</span><span class="headerlabelscurrencycodespanforsalesprice">in ' + currencycode + '</span></div></div>');
    }
    ...
    function pagenumberer(){
            ...
            $('span[class="firstpagefooterspan3"]').text( "Number of Supplier Order: " + $('#numberofsupplierorder').text()); // firstpage footer filling
            ...
            $('span[class="middlepagesfooterspan3"]').text( "Number of Supplier Order: " + $('#numberofsupplierorder').text()); // middlepages number of supplierorder filling

            $('span[class="backpagefooterspan2"]').text( "page " + (pagenumber+1) + "/" + (pagenumber+1)); // backpage footer filling
            $('span[class="backpagefooterspan3"]').text( "Number of Supplier Order: " + $('#numberofsupplierorder').text()); // backpage footer filling
