...
INSERT INTO `quotation_tblcompanies` VALUES (1,'C123222234'),(2,'Company23'),(6,'Company3');
...
INSERT INTO `quotation_tblcontacts` VALUES (1,'Firstname1','Lastname1',6),(2,'Company2firstname1','Company2lastname1',2),(3,'Company2firstname2','Company2lastname2',2),(4,'Firstname of company1','Lastname of company1',1);
...
INSERT INTO `quotation_tbldoc` VALUES (1,'6726','Szeged',1,3),(2,'7777','Pécs',1,1),(3,'9999','Győr',1,1),(4,'5555','Békéscsaba',2,1),(5,'4444','Nyíregyháza',3,1),(6,'3333','Eger',3,1),(9,NULL,NULL,1,2);
...
INSERT INTO `quotation_tbldoc_details` VALUES (4,6,2,2,4,0,0,0,'Defaultnote6','2018-12-01 11:19:36.565808'),(5,1,3,3,18,0,0,0,'Defaultnote18','2018-11-21 05:52:25.443132'),(28,1,2,1,33,0,1,0,'Defaultnote','2018-12-01 11:49:48.151479'),(29,1,3,1,2,0,0,0,'Defaultnote','2018-12-01 11:53:40.073139'),(32,1,4,1,1,0,0,0,'Defaultnote','2018-11-21 05:52:25.443132'),(33,1,5,1,2,0,2,0,'Defaultnote2','2018-11-21 05:52:25.443132'),(48,1,2,1,33345678,0,2,0,'Defaultnote','2018-12-01 11:58:43.782194'),(49,1,1,1,122,2,0,0,'Defaultnote','2018-12-09 18:52:04.989431'),(50,42,1,1,11,3112,124,212,'132t','2018-12-09 21:30:46.843437'),(53,1,9,1,1,0,0,0,'Defaultnote','2018-12-01 20:24:40.488388');
...
INSERT INTO `quotation_tblproduct` VALUES (1,133,'Somethin'),(2,25,'Something'),(3,3,'Pr3'),(4,5,'Pr5e'),(5,6,'Pr6'),(6,7,'Pr7');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `tr_tblProduct_afterupdate` AFTER UPDATE ON `quotation_tblproduct` FOR EACH ROW BEGIN
	DECLARE
	XX VARCHAR(33);
...
-- Dump completed on 2018-12-11 16:02:16
